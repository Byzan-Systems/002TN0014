...
Public Class ClsBase
    ...
    Public Sub New(ByVal _StrIniPath As String)
        ...
        Try
            ...
            strRes_OutputFolderPath = GetINISettings("General", "Res_Output Folder", _StrIniPath)
            strMasterPath = GetINISettings("General", "Master", _StrIniPath)

            strDecryptKey = GetINISettings("General", "Decrypt Key", _StrIniPath)
            ...
            ''''''''''''''''''''''Commented by swati dtd 2021-04-21
            '  strUtilityCode = GetINISettings("Client Details", "Utility Code", _StrIniPath)
            '  strClientShortName = GetINISettings("Client Details", "Client short name", _StrIniPath)
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''
            strYBL_Nomenclature_Format = GetINISettings("Client Details", "YBL Nomenclature Format", _StrIniPath)
            strInputDateFormat = GetINISettings("Client Details", "Input Date Format", _StrIniPath)

            'Response
            strBank = GetINISettings("Client Details", "Bank Scheme code", _StrIniPath)
            strBankUserName = GetINISettings("Client Details", "Bank User Name", _StrIniPath)
            strResFile_Nomenclature_Format = GetINISettings("Client Details", "Response File Nomenclature Format", _StrIniPath)
